...
const ResultCard = ({
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center px-2 sm:px-3 print:px-0">
        <div
          className="result-card-print w-full max-w-[281mm] border-2 border-primary rounded-xl p-2 sm:p-4 shadow-xl bg-card text-[10px] sm:text-[11px] leading-tight text-primary print:shadow-none flex flex-col print:min-h-[194mm]"
        >
          ...
          {/* Student info bar */}
          <div className="flex flex-wrap sm:flex-nowrap items-center gap-x-3 gap-y-1 text-[10px] border border-primary rounded p-1.5 mb-2 print:flex-nowrap print:whitespace-nowrap print:overflow-hidden">
          ...
          {activeTerm === "Result Summary" ? (
            <div>
              ...
              <table className="w-full min-w-[520px] border border-primary text-[10px]">
              ...
              <div className="overflow-x-auto -mx-2 sm:mx-0 px-2 sm:px-0">
              <table className="w-full min-w-[480px] border border-primary text-[10px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <div className="overflow-x-auto -mx-2 sm:mx-0 px-2 sm:px-0">
                <table className="w-full min-w-[420px] border border-primary text-[10px]">
              ...
              <div>
                ...
                <div className="overflow-x-auto -mx-2 sm:mx-0 px-2 sm:px-0">
                <table className="w-full min-w-[260px] border border-primary/50 text-[10px]">
          ...
          <div className="mt-auto pt-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 text-[10px] border-t border-b border-primary py-3">
              <DottedField label="Attendance" />
              <DottedField label="Promoted To" />
              <DottedField label="School Reopens On" />
            </div>

            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-center text-[10px] items-end">
              <div>
